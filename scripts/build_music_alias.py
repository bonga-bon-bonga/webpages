...
HASH_PATH = (
    os.environ.get("MUSIC_ALIAS_HASH_PATH")
    or "nemupipiano-musiclist-search/data/hash/music_alias_dictionary"
)
...
def main():
    ...
    if has_unchanged_input(HASH_PATH, sheet_hash, OUTPUT_JSON_PATH):
        print("Music alias spreadsheet is unchanged. Skipping update.")
        return
